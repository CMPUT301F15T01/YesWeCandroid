 ...
 */
public class ImageButtonArrayAdapter extends ArrayAdapter<Bitmap> {
     ...
     */
    public ImageButtonArrayAdapter(Context context, int resource, List<Bitmap> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.imageButton.setImageBitmap(this.getItem(position));
        return convertView;
    }
}
