...
public class Picture extends ElasticStorable implements ca.ualberta.trinkettrader.Observable {
     ...
     *
     * @param picture          json object generated by the toJson method of this class
     * @param directoryManager directory manager that can be used to store the picture
     * @throws IllegalArgumentException
     * @throws IOException
     * @throws PackageManager.NameNotFoundException
     */
    public Picture(String picture, PictureDirectoryManager directoryManager) throws IllegalArgumentException, IOException, PackageManager.NameNotFoundException {
    ...
    /**
     * Converts the image into a JSON representation. The returned
     * string has a filename and the raw bytes of the compressed image.
     *
